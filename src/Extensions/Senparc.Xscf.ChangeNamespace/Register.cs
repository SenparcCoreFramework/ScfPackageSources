...
namespace Senparc.Xscf.ChangeNamespace
{
    ...
    public class Register : XscfRegisterBase, IXscfRegister
    {
        ...
        public override string Version => "0.3.8";//必须填写版本号
        ...
        public override string Description => "此模块提供给开发者在安装完 SCF、发布产品之前，全局修改命名空间，请在生产环境中谨慎使用，此操作不可逆！必须做好提前备份！不建议在已经部署至生产环境并开始运行后使用此功能！";
